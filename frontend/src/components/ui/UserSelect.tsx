...
export function UserSelect({ users, value, onChange, placeholder = 'Search and select user...', className }: UserSelectProps) {
  ...
  return (
    <div className={`relative ${className || ''}`} ref={ref}>
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute z-50 mt-1.5 w-full bg-white rounded-xl shadow-2xl ring-1 ring-gray-200/50 overflow-hidden animate-fade-in-scale" style={{ animationDuration: '0.12s' }}>
          {/* Search input */}
